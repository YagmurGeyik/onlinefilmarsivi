...
},
{
  ...
  country: "ABD",
  duration: "175 dakika",
  description: "Mafya ailesi Corleone'nin güç, sadakat ve ihanetle dolu yükselişini anlatan The Godfather, suç sinemasının zirvesidir. Don Vito Corleone'nin ailesini korumak adına verdiği kararlar, güç dengelerini değiştirir. Michael Corleone’nin soğukkanlı dönüşümü, aile bağlarının hem koruyucu hem yıkıcı yönünü gözler önüne serer. Film, gelenek, göçmen kimliği ve Amerikan rüyası üzerine de derin yorumlar sunar. Coppola'nın karanlık ve büyüleyici atmosferiyle, her kare bir tablo gibi akılda kalır.",
  poster: godfather
},
{
  id: 3,
...
},
{
  ...
  country: "ABD",
  duration: "142 dakika",
  description: "Düşük IQ'suna rağmen olağanüstü bir hayat süren Forrest, Amerika'nın tarihindeki önemli anlara tanıklık eder. Vietnam Savaşı'ndan ping pong diplomasisine, aşkı Jenny'ye olan sadakatine kadar dolu dolu bir öykü anlatır. Tom Hanks'in içten performansı, karakterin naifliğini ve iyiliğini öne çıkarır. Film sevgi, kader, azim ve kabullenme temalarını sıcak bir mizahla harmanlar. İnsanların hayatını değiştiren basit ama anlamlı sözleriyle hafızalara kazınır.",
  poster: forrestgump
},
{
  id: 7,
...
},
{
  ...
  country: "ABD",
  duration: "180 dakika",
  description: "Jordan Belfort’un hızlı yükselişi, zenginliği ve düşüşü, Wall Street’in çılgın dünyasında sansasyonel bir şekilde anlatılır. Martin Scorsese’nin yönettiği film, aşırı tüketim, ahlaksızlık ve hırsı acımasızca gözler önüne serer. Leonardo DiCaprio’nun enerjik performansı, karakterin karmaşıklığını ve çalkantılı hayatını yansıtır. Film, hızla değişen finans dünyasının karanlık yanlarını ironik bir dille eleştirir. Eğlenceli ve çarpıcı sahneleriyle unutulmaz bir biyografik yapım.",
  poster: wolf
},
{
  id: 20,
...
},
{
  ...
  duration: "150 dakika",
  description: "II. Dünya Savaşı sırasında Varşova gettosunda hayatta kalmaya çalışan piyanist Władysław Szpilman’ın gerçek hikayesi. Müzik ve insan ruhunun direnci temalarını dokunaklı şekilde işler. Roman Polanski’nin yönetmenliği ve Adrien Brody’nin performansı unutulmazdır. Film, savaşın acımasız yüzünü ve insanlık dramını güçlü görsellerle anlatır. Tarihin karanlık dönemlerine ışık tutan bir başyapıt.",
  poster: pianist
},
{
  id: 29,
